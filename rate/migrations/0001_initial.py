# Generated by Django 3.1.2 on 2021-01-24 22:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project', to='rate.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rate', to='rate.project')),
        ...
        migrations.AddField(
            model_name='profile',
            name='rate',
            field=models.ManyToManyField(max_length=30, related_name='image', to='rate.Project'),
        ),
    ]
